    ...
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          I am a Full Stack Engineer with experience developing and maintaining scalable backend and frontend services for high-traffic web applications. I hold a Master's degree in Computer Science with a focus on GIS and Data Science, and I am passionate about creating impactful digital experiences.
          </p>
